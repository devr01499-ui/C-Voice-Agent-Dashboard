...
const stats = [
  { name: "Total Calls", value: "2,543", icon: Phone, trend: "+12.5%", color: "blue" },
  { name: "Completed", value: "2,100", icon: CheckCircle2, trend: "+23.1%", color: "purple" },
  { name: "Minutes Used", value: "2,543", icon: Clock, trend: "+10.1%", color: "cyan" },
];
